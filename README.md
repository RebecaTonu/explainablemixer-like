...
1. **Balance After = 0 **  
   Captures transactions where the remaining balance of an address becomes zero after spending. This reflects a pattern consistent with mixer operations, where funds are fully redistributed without retention.

---

2. **Delay hours **  
   Introduces a temporal dimension by computing the time interval  in hours between two related transactions.  
...
5. **Temporal balance depletion (**  
   Models a complete mixer-like execution pattern by combining temporal and balance-based signals.  
